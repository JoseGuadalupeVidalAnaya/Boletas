    ...
    <nav>
        <div class = "nav-wrapper">
            ...
            <ul class = "right hide-on-med-and-down">
                ...
                <li><a class = "dropdown-button" href = "#!" data-activates = "dropdown1">Mi perfil<i
            ...
            <ul class = "side-nav" id = "mobile-menu">
                ...
                <li><a href = "#">Editar</a></li>
                <li><a href = "#">Agregar</a></li>
                <li><a class = "dropdown-button2" href = "#!" data-activates = "dropdown2">Sesión<i
                                class = "material-icons right">arrow_drop_down</i></a></li>
            </ul>
        </div>
    </nav>
                ...
                <form action = "<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method = "post">
                    ...
                    <div class = "input-field">
                        <button id = "aceptar" class = "waves-effect waves-light btn-large disabled"
                                type = "submit" name = "aceptar">Aceptar
                        </button>
                    </div>
                </form>
            </div>
