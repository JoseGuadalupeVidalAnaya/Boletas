            ...
            <div class = "card-content grey lighten-4">
                    ...
                    <form action = "<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method = "post">
                        <div class = "input-field">
                            ...
                            <input id = "controlA"
                                   ...
                                   type = "number" maxlength = "13" data-length = "13" required = "required"
                                   name = "controlA"
                                <?php
                        ...
                        <br>
                        <div class = "input-field">
                            <button id = "enviar" class = "waves-effect waves-light btn-large disabled" type = "submit"
                                    name = "enviar">Acceder
                            </button>
                        </div>
                        <br>
                ...
                <div id = "registro">
                    <form action = "<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method = "post">
                        ...
                        <div class = "input-field">
                            <i class = "material-icons prefix">keyboard</i>
                            <input id = "control" type = "number" data-length = "13" required = "required"
                                   name = "control"
                                <?php
